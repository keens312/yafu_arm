...
int main(int argc, char *argv[])
{
    ...
    if (1)
    {
        fobj->HAS_SSE41 = comp_info.bSSE41Extensions = 0;
    }


    if (1)
    {
        fobj->HAS_AVX2 = comp_info.AVX2 = 0;
    }


    if (1)
    {
        fobj->HAS_AVX = comp_info.AVX = 0;
    }

    if (1)
    {
        fobj->HAS_BMI2 = comp_info.BMI2 = 0;
    }  

    if (1)
    {
        fobj->HAS_AVX512F = comp_info.AVX512F = 0;
    }

    if (1)
    {
        fobj->HAS_AVX512BW = comp_info.AVX512BW = 0;
    }
